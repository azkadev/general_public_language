...
class JsonSchemeGeneralDeveloper {
  /// return original data json
  Map rawData;

  /// return original data json
  JsonSchemeGeneralDeveloper(this.rawData);
  ...
  /// GeneralUniverse
  static JsonSchemeGeneralDeveloper empty() {
    return JsonSchemeGeneralDeveloper({});
  }

  /// return original data json
  static JsonSchemeGeneralDeveloper create({
    String special_type = "JsonSchemeGeneralDeveloper",
  }) {
    ...
    return JsonSchemeGeneralDeveloper(jsonCreate);
  }
...
/// GeneralUniverse
extension JsonSchemeGeneralUniverseExtensions on List<JsonSchemeGeneralDeveloper> {
  /// GeneralUniverse
  List<Map> toMap() {
    return toJson();
  }
